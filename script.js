const assets = [
  { name: "Bitcoin", symbol: "BTC", price: "$67,850.25", change: "+1.8%", color: "#f7931a", api: "coindesk" },
  { name: "Gold", symbol: "XAU", price: "$2,625.40", change: "+0.5%", color: "#d4af37", api: "metals" },
  { name: "Silver", symbol: "XAG", price: "$31.25", change: "+0.9%", color: "#c0c0c0", api: "metals" },
  { name: "10-Year Treasury Yield", symbol: "10Y", price: "4.28%", change: "-0.04%", color: "#6a5acd", api: "treasury", tooltip: "Reveals the cost of government debt financing and signals market expectations for inflation. Rising yields expose the unsustainable nature of endless deficit spending and currency debasement." },
  { name: "Dollar Index", symbol: "DXY", price: "103.15", change: "-0.2%", color: "#20b2aa", api: "forex", tooltip: "Measures the strength of the US dollar against a basket of major foreign currencies. Declining values reflect the erosion of purchasing power through monetary expansion." }
];
...
const historicalData = {
  "Bitcoin": [
    ...
    { year: 2024, data: [45000, 52000, 61000, 64000, 59000, 62000, 65000, 67000, 66000, 68000, 67500, 67850] },
    { year: 2025, data: [66500, 68200, 69500, 68700, 67850] }
  ],
  "Gold": [
    ...
    { year: 2025, data: [2580, 2610, 2640, 2615, 2625] }
  ],
  "Silver": [
    ...
    { year: 2024, data: [23.8, 25.6, 26.9, 27.5, 28.2, 28.9, 29.3, 29.8, 30.2, 30.5, 31.0, 31.25] },
    { year: 2025, data: [30.9, 31.2, 31.5, 31.3, 31.25] }
  ],
  "10-Year Treasury Yield": [
    ...
    { year: 2025, data: [4.30, 4.32, 4.35, 4.30, 4.28] }
  ],
  "Dollar Index": [
    ...
    { year: 2024, data: [103.4, 104.1, 104.5, 105.2, 104.8, 104.3, 103.9, 103.7, 103.5, 103.3, 103.2, 103.15] },
    { year: 2025, data: [103.6, 103.5, 103.3, 103.2, 103.15] }
  ]
};
